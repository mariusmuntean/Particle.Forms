...
{
    public class GitHubLogoParticle : ParticleBase
    {
        private SKPaint _paint = new SKPaint
        {
            Style = SKPaintStyle.Fill,
            Color = SKColor.Parse("#1B1F23")
        };

        public GitHubLogoParticle(SKPoint3 rotationSpeed, float translationSpeed, float direction, SKPoint3 orientation, SKPoint position, SKSize size) : base(rotationSpeed, translationSpeed, direction, orientation, position, size)
        {
        }
